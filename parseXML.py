...
if __name__ == "__main__":
    annos_path = '/media/whisper/Other/data/individual_behavior/rest2/annotations.xml'
    out_path = '/media/whisper/Other/data/individual_behavior/rest2/out.xml'
    ################ 1. 读取xml文件  ##########
    tree = read_xml(annos_path)
    ...
    text_nodes = get_node_by_keyvalue(
        find_nodes(
            tree, "track/box/attribute"
        ),
        {"name": "state"}
    ) # 定位节点
    change_node_text(text_nodes, "rest")
